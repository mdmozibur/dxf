...
namespace IxMilia.Dxf.Objects
{
    ...
    public partial class DxfSortentsTable : DxfObject, IDxfItemInternal
    {
        ...
        protected override void AddValuePairs(List<DxfCodePair> pairs, DxfAcadVersion version, bool outputHandles, bool writeXData)
        {
            ...
            pairs.AddRange(this.EntitiesPointers.Pointers.Where(p => p.Handle.Value != 0).Select(p => new DxfCodePair(331, DxfCommonConverters.HandleString(p.Handle))));
            pairs.AddRange(this.SortItemsPointers.Pointers.Where(p => p.Handle.Value != 0).Select(p => new DxfCodePair(5, DxfCommonConverters.HandleString(p.Handle))));
            if (writeXData)
            {
