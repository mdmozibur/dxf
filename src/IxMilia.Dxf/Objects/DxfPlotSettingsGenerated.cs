...
namespace IxMilia.Dxf.Objects
{
    ...
    public partial class DxfPlotSettings : DxfObject, IDxfItemInternal
    {
        ...
        private string _plotViewName { get; set; }
        ...
        protected override void AddValuePairs(List<DxfCodePair> pairs, DxfAcadVersion version, bool outputHandles, bool writeXData)
        {
            ...
            pairs.Add(new DxfCodePair(6, this._plotViewName));
            ...
            if (this.ShadePlotObjectPointer.Handle.Value != 0)
            {
                pairs.Add(new DxfCodePair(333, DxfCommonConverters.HandleString(this.ShadePlotObjectPointer.Handle)));
            }
        ...
        internal override bool TrySetPair(DxfCodePair pair)
        {
            switch (pair.Code)
            {
                ...
                case 4:
                    ...
                    break;
                case 6:
                    this._plotViewName = pair.StringValue;
                    break;
                case 7:
                ...
                case 149:
                    ...
                    break;
                case 333:
                    this.ShadePlotObjectPointer.Handle = DxfCommonConverters.HandleString(pair.StringValue);
                    break;
                default:
