...
namespace IxMilia.Dxf.Objects
{
    ...
    public partial class DxfLayerIndex : DxfObject, IDxfItemInternal
    {
        ...
        protected override void AddValuePairs(List<DxfCodePair> pairs, DxfAcadVersion version, bool outputHandles, bool writeXData)
        {
            ...
            pairs.AddRange(this.IdBuffersPointers.Pointers.Where(p => p.Handle.Value != 0).Select(p => new DxfCodePair(360, DxfCommonConverters.HandleString(p.Handle))));
        ...
        internal override bool TrySetPair(DxfCodePair pair)
        {
            switch (pair.Code)
            {
                ...
                case 90:
                    ...
                    break;
                case 360:
                    this.IdBuffersPointers.Pointers.Add(new DxfPointer(DxfCommonConverters.HandleString(pair.StringValue)));
                    break;
                default:
