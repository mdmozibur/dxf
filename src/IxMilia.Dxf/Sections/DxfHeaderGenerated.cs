...
namespace IxMilia.Dxf
{
    public partial class DxfHeader
    {
        ...
        /// <summary>
        /// The $ACADMAINTVER header variable.  Maintenance version number (should be ignored).  Minimum AutoCAD version: R14.  Maximum AutoCAD version: R2013.
        /// </summary>
        ...
        /// </summary>
        public DxfHandle SolidVisualStylePointer { get; set; }
        ...
        /// </summary>
        public DxfAlternateUnitZeroSuppression AlternateDimensioningZeroSupression { get; set; }

        /// <summary>
        /// The $DIMALTTZ header variable.  Controls suppression of zeros for alternate tolerance values.  Minimum AutoCAD version: R13.
        /// </summary>
        public DxfAlternateToleranceZeroSuppression AlternateDimensioningToleranceZeroSupression { get; set; }
        ...
        /// </summary>
        public DxfHandle NextAvailableHandle { get; set; }
        ...
        /// </summary>
        public short PEditSmoothMDensity { get; set; }

        /// <summary>
        /// The $SURFV header variable.  Surface density (for PEDIT Smooth) in N direction.
        /// </summary>
        public short PEditSmoothNDensity { get; set; }
        ...
        /// </summary>
        public bool PreviousReleaseTileCompatibility { get; set; }
        ...
        /// </summary>
        public bool IsPolylineContinuousAroundVertices { get; set; }
        ...
        /// </summary>
        public bool DisplayLineweightInModelAndLayoutTab { get; set; }
        ...
        /// </summary>
        public DxfHandle NewObjectPlotStyleHandle { get; set; }
        ...
        /// </summary>
        public bool HideTextObjectsWhenProducingHiddenView { get; set; }
        ...
        /// </summary>
        public DxfHandle CurrentMaterialHandle { get; set; }
        ...
        /// </summary>
        public DxfHandle InterferenceObjectVisualStylePointer { get; set; }
        ...
        /// </summary>
        public DxfHandle InterferenceViewPortVisualStylePointer { get; set; }
        ...
        public void SetDefaults()
        {
            ...
            this.MaintenanceVersion = 0; // ACADMAINTVER
            ...
            this.SolidVisualStylePointer = default(DxfHandle); // DRAGVS
            ...
            this.DimensionToleranceZeroSuppression = DxfToleranceZeroSuppression.SuppressZeroFeetAndZeroInches; // DIMTZIN
            this.AlternateDimensioningZeroSupression = DxfAlternateUnitZeroSuppression.SuppressZeroFeetAndZeroInches; // DIMALTZ
            this.AlternateDimensioningToleranceZeroSupression = DxfAlternateToleranceZeroSuppression.SuppressZeroFeetAndZeroInches; // DIMALTTZ
            ...
            this.DimensionAngleZeroSuppression = DxfAngularZeroSuppression.DisplayAllLeadingAndTrailingZeros; // DIMAZIN
            ...
            this.NextAvailableHandle = default(DxfHandle); // HANDSEED
            ...
            this.PEditSmoothMDensity = 6; // SURFU
            this.PEditSmoothNDensity = 6; // SURFV
            ...
            this.OrthographicViewType = DxfOrthographicViewType.None; // UCSORTHOVIEW
            ...
            this.PreviousReleaseTileCompatibility = true; // TILEMODE
            ...
            this.IsPolylineContinuousAroundVertices = false; // PLINEGEN
            ...
            this.DisplayLineweightInModelAndLayoutTab = false; // LWDISPLAY
            ...
            this.NewObjectPlotStyleHandle = default(DxfHandle); // CEPSNID
            ...
            this.HideTextObjectsWhenProducingHiddenView = false; // HIDETEXT
            ...
            this.CurrentMaterialHandle = default(DxfHandle); // CMATERIAL
            ...
            this.InterferenceObjectVisualStylePointer = default(DxfHandle); // INTERFEREOBJVS
            this.InterferenceViewPortVisualStylePointer = default(DxfHandle); // INTERFEREVPVS
        ...
        internal void AddValueToList(List<DxfCodePair> list)
        {
            ...
            // ACADMAINTVER
            if (Version >= DxfAcadVersion.R14 && Version <= DxfAcadVersion.R2013)
            {
                list.Add(new DxfCodePair(9, ACADMAINTVER));
                list.Add(new DxfCodePair(70, (short)this.MaintenanceVersion));
            }

            // ACADMAINTVER
            if (Version >= DxfAcadVersion.R2018)
            {
                list.Add(new DxfCodePair(9, ACADMAINTVER));
                list.Add(new DxfCodePair(90, this.MaintenanceVersion));
            }
            ...
            list.Add(new DxfCodePair(40, EnsurePositiveOrDefault(this.DefaultTextHeight, 0.2)));

            // TRACEWID
            list.Add(new DxfCodePair(9, TRACEWID));
            list.Add(new DxfCodePair(40, EnsurePositiveOrDefault(this.TraceWidth, 0.05)));

            // TEXTSTYLE
            list.Add(new DxfCodePair(9, TEXTSTYLE));
            list.Add(new DxfCodePair(7, DefaultIfNullOrEmpty(this.TextStyle, "STANDARD")));

            // CLAYER
            list.Add(new DxfCodePair(9, CLAYER));
            list.Add(new DxfCodePair(8, DefaultIfNullOrEmpty(this.CurrentLayer, "0")));

            // CELTYPE
            list.Add(new DxfCodePair(9, CELTYPE));
            list.Add(new DxfCodePair(6, DefaultIfNullOrEmpty(this.CurrentEntityLineType, "BYLAYER")));
            ...
            // DRAGVS
            if (Version >= DxfAcadVersion.R2007 && this.SolidVisualStylePointer != default(DxfHandle))
            {
                list.Add(new DxfCodePair(9, DRAGVS));
                list.Add(new DxfCodePair(349, HandleString(this.SolidVisualStylePointer)));
            }
            ...
            list.Add(new DxfCodePair(2, DefaultIfNullOrEmpty(this.DimensionStyleName, "STANDARD")));
            ...
            list.Add(new DxfCodePair(5, HandleString(this.NextAvailableHandle)));
            ...
            list.Add(new DxfCodePair(70, this.PEditSmoothMDensity));

            // SURFV
            list.Add(new DxfCodePair(9, SURFV));
            list.Add(new DxfCodePair(70, this.PEditSmoothNDensity));
            ...
            if (Version >= DxfAcadVersion.R2000)
            {
                ...
                list.Add(new DxfCodePair(70, (short)this.OrthographicViewType));
            }
            ...
            if (Version >= DxfAcadVersion.R11)
            {
                ...
                list.Add(new DxfCodePair(70, BoolShort(this.PreviousReleaseTileCompatibility)));
            }
            ...
            if (Version >= DxfAcadVersion.R11)
            {
                ...
                list.Add(new DxfCodePair(70, BoolShort(this.IsPolylineContinuousAroundVertices)));
            }
            ...
            if (Version >= DxfAcadVersion.R2000)
            {
                ...
                list.Add(new DxfCodePair(290, this.DisplayLineweightInModelAndLayoutTab));
            }
            ...
            // CEPSNID
            if (Version >= DxfAcadVersion.R2000 && this.NewObjectPlotStyleHandle != default(DxfHandle))
            {
                list.Add(new DxfCodePair(9, CEPSNID));
                list.Add(new DxfCodePair(390, HandleString(this.NewObjectPlotStyleHandle)));
            }
            ...
            if (Version >= DxfAcadVersion.R2004)
            {
                ...
                list.Add(new DxfCodePair(280, BoolShort(this.HideTextObjectsWhenProducingHiddenView)));
            }
            ...
            if (Version >= DxfAcadVersion.R2004 && Version <= DxfAcadVersion.R2007)
            {
                ...
                list.Add(new DxfCodePair(290, (int)this.IsXRefClippingBoundaryVisible != 0));
            }
            ...
            // CMATERIAL
            if (Version >= DxfAcadVersion.R2007 && this.CurrentMaterialHandle != default(DxfHandle))
            {
                list.Add(new DxfCodePair(9, CMATERIAL));
                list.Add(new DxfCodePair(347, HandleString(this.CurrentMaterialHandle)));
            }
            ...
            // INTERFEREOBJVS
            if (Version >= DxfAcadVersion.R2007 && this.InterferenceObjectVisualStylePointer != default(DxfHandle))
            {
                list.Add(new DxfCodePair(9, INTERFEREOBJVS));
                list.Add(new DxfCodePair(345, HandleString(this.InterferenceObjectVisualStylePointer)));
            }

            // INTERFEREVPVS
            if (Version >= DxfAcadVersion.R2007 && this.InterferenceViewPortVisualStylePointer != default(DxfHandle))
            {
                list.Add(new DxfCodePair(9, INTERFEREVPVS));
                list.Add(new DxfCodePair(346, HandleString(this.InterferenceViewPortVisualStylePointer)));
            }
        ...
        internal void SetHeaderVariable(string keyName, DxfCodePair pair)
        {
            switch (keyName)
            {
                ...
                case ACADMAINTVER:
                    ...
                    {
                        case 70:
                            this.MaintenanceVersion = pair.ShortValue;
                            break;
                        case 90:
                            this.MaintenanceVersion = pair.IntegerValue;
                            break;
                        default:
                            Debug.Assert(false, $"Expected code [70, 90], got {pair.Code}");
                            break;
                    }
                    break;
                case DWGCODEPAGE:
                ...
                case DRAGVS:
                    EnsureCode(pair, 349);
                    this.SolidVisualStylePointer = HandleString(pair.StringValue);
                    break;
                case DIMSCALE:
                    EnsureCode(pair, 40);
                ...
                case DIMTZIN:
                    EnsureCode(pair, 70);
                    this.DimensionToleranceZeroSuppression = (DxfToleranceZeroSuppression)pair.ShortValue;
                    break;
                case DIMALTZ:
                    EnsureCode(pair, 70);
                    this.AlternateDimensioningZeroSupression = (DxfAlternateUnitZeroSuppression)pair.ShortValue;
                    break;
                case DIMALTTZ:
                    EnsureCode(pair, 70);
                    this.AlternateDimensioningToleranceZeroSupression = (DxfAlternateToleranceZeroSuppression)pair.ShortValue;
                    break;
                case DIMFIT:
                    EnsureCode(pair, 70);
                ...
                case DIMAZIN:
                    EnsureCode(pair, 70);
                    this.DimensionAngleZeroSuppression = (DxfAngularZeroSuppression)pair.ShortValue;
                    break;
                case DIMDSEP:
                    EnsureCode(pair, 70);
                ...
                case HANDSEED:
                    EnsureCode(pair, 5);
                    this.NextAvailableHandle = HandleString(pair.StringValue);
                    break;
                case SURFTAB1:
                    EnsureCode(pair, 70);
                ...
                case SURFU:
                    EnsureCode(pair, 70);
                    this.PEditSmoothMDensity = pair.ShortValue;
                    break;
                case SURFV:
                    EnsureCode(pair, 70);
                    this.PEditSmoothNDensity = pair.ShortValue;
                    break;
                case UCSBASE:
                    EnsureCode(pair, 2);
                ...
                case UCSORTHOVIEW:
                    EnsureCode(pair, 70);
                    this.OrthographicViewType = (DxfOrthographicViewType)pair.ShortValue;
                    break;
                case UCSORGTOP:
                ...
                case TILEMODE:
                    EnsureCode(pair, 70);
                    this.PreviousReleaseTileCompatibility = BoolShort(pair.ShortValue);
                    break;
                case MAXACTVP:
                    EnsureCode(pair, 70);
                ...
                case PLINEGEN:
                    EnsureCode(pair, 70);
                    this.IsPolylineContinuousAroundVertices = BoolShort(pair.ShortValue);
                    break;
                case PSLTSCALE:
                    EnsureCode(pair, 70);
                ...
                case LWDISPLAY:
                    EnsureCode(pair, 290);
                    this.DisplayLineweightInModelAndLayoutTab = pair.BoolValue;
                    break;
                case INSUNITS:
                    EnsureCode(pair, 70);
                ...
                case CEPSNID:
                    EnsureCode(pair, 390);
                    this.NewObjectPlotStyleHandle = HandleString(pair.StringValue);
                    break;
                case CEPSNTYPE:
                    EnsureCode(pair, 380);
                ...
                case HIDETEXT:
                    ...
                    {
                        case 280:
                            this.HideTextObjectsWhenProducingHiddenView = BoolShort(pair.ShortValue);
                            break;
                        case 290:
                            this.HideTextObjectsWhenProducingHiddenView = pair.BoolValue;
                            break;
                        default:
                ...
                case XCLIPFRAME:
                    ...
                    {
                        case 290:
                            this.IsXRefClippingBoundaryVisible = pair.BoolValue ? (DxfXrefClippingBoundaryVisibility)1 : (DxfXrefClippingBoundaryVisibility)0;
                            break;
                        case 280:
                ...
                case CMATERIAL:
                    EnsureCode(pair, 347);
                    this.CurrentMaterialHandle = HandleString(pair.StringValue);
                    break;
                case SOLIDHIST:
                    EnsureCode(pair, 280);
                ...
                case INTERFEREOBJVS:
                    EnsureCode(pair, 345);
                    this.InterferenceObjectVisualStylePointer = HandleString(pair.StringValue);
                    break;
                case INTERFEREVPVS:
                    EnsureCode(pair, 346);
                    this.InterferenceViewPortVisualStylePointer = HandleString(pair.StringValue);
                    break;
                case CSHADOW:
                    EnsureCode(pair, 280);
        ...
        private object GetValue(string variableName)
        {
            switch (variableName.ToUpper())
            {
                ...
                case SURFU:
                    return this.PEditSmoothMDensity;
                case SURFV:
                    return this.PEditSmoothNDensity;
                case UCSBASE:
                ...
                case UCSORTHOVIEW:
                    return this.OrthographicViewType;
                case UCSORGTOP:
                ...
                case TILEMODE:
                    return this.PreviousReleaseTileCompatibility;
                case MAXACTVP:
                ...
                case PLINEGEN:
                    return this.IsPolylineContinuousAroundVertices;
                case PSLTSCALE:
                ...
                case LWDISPLAY:
                    return this.DisplayLineweightInModelAndLayoutTab;
                case INSUNITS:
                ...
                case HIDETEXT:
                    return this.HideTextObjectsWhenProducingHiddenView;
                case XCLIPFRAME:
        ...
        private void SetValue(string variableName, object value)
        {
            switch (variableName.ToUpper())
            {
                case ACADVER:
                    ...
                    break;
                case ACADMAINTVER:
                    this.MaintenanceVersion = (int)value;
                    break;
                case DWGCODEPAGE:
                ...
                case DISPSILH:
                    ...
                    break;
                case DRAGVS:
                    this.SolidVisualStylePointer = (DxfHandle)value;
                    break;
                case DIMSCALE:
                ...
                case DIMTOLJ:
                    ...
                    break;
                case DIMTZIN:
                    this.DimensionToleranceZeroSuppression = (DxfToleranceZeroSuppression)value;
                    break;
                case DIMALTZ:
                    this.AlternateDimensioningZeroSupression = (DxfAlternateUnitZeroSuppression)value;
                    break;
                case DIMALTTZ:
                    this.AlternateDimensioningToleranceZeroSupression = (DxfAlternateToleranceZeroSuppression)value;
                    break;
                case DIMFIT:
                ...
                case DIMALTRND:
                    ...
                    break;
                case DIMAZIN:
                    this.DimensionAngleZeroSuppression = (DxfAngularZeroSuppression)value;
                    break;
                case DIMDSEP:
                ...
                case HANDLING:
                    ...
                    break;
                case HANDSEED:
                    this.NextAvailableHandle = (DxfHandle)value;
                    break;
                case SURFTAB1:
                ...
                case SURFTYPE:
                    ...
                    break;
                case SURFU:
                    this.PEditSmoothMDensity = (short)value;
                    break;
                case SURFV:
                    this.PEditSmoothNDensity = (short)value;
                    break;
                case UCSBASE:
                ...
                case UCSORTHOREF:
                    ...
                    break;
                case UCSORTHOVIEW:
                    this.OrthographicViewType = (DxfOrthographicViewType)value;
                    break;
                case UCSORGTOP:
                ...
                case SHADEDIF:
                    ...
                    break;
                case TILEMODE:
                    this.PreviousReleaseTileCompatibility = (bool)value;
                    break;
                case MAXACTVP:
                ...
                case VISRETAIN:
                    ...
                    break;
                case PLINEGEN:
                    this.IsPolylineContinuousAroundVertices = (bool)value;
                    break;
                case PSLTSCALE:
                ...
                case JOINSTYLE:
                    ...
                    break;
                case LWDISPLAY:
                    this.DisplayLineweightInModelAndLayoutTab = (bool)value;
                    break;
                case INSUNITS:
                ...
                case XEDIT:
                    ...
                    break;
                case CEPSNID:
                    this.NewObjectPlotStyleHandle = (DxfHandle)value;
                    break;
                case CEPSNTYPE:
                ...
                case INDEXCTL:
                    ...
                    break;
                case HIDETEXT:
                    this.HideTextObjectsWhenProducingHiddenView = (bool)value;
                    break;
                case XCLIPFRAME:
                ...
                case TILEMODELIGHTSYNCH:
                    ...
                    break;
                case CMATERIAL:
                    this.CurrentMaterialHandle = (DxfHandle)value;
                    break;
                case SOLIDHIST:
                ...
                case INTERFERECOLOR:
                    ...
                    break;
                case INTERFEREOBJVS:
                    this.InterferenceObjectVisualStylePointer = (DxfHandle)value;
                    break;
                case INTERFEREVPVS:
                    this.InterferenceViewPortVisualStylePointer = (DxfHandle)value;
                    break;
                case CSHADOW:
